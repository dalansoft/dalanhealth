...
const faqs = [
  { q: 'How does pricing work?', a: 'Simple pay-per-use: ₹9 + GST per visit, deducted from your prepaid wallet only when a consultation is marked complete. Charged per visit, not per patient — if a patient visits twice in a month, that is 2 × ₹9 + GST. Cancellations, no-shows and unconsulted tokens are never charged. No monthly fee, no annual contract.' },
