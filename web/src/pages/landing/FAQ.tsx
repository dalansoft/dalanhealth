...
const faqs = [
  { q: 'How does pricing work?', a: 'Simple pay-per-use: 9rs+gst per visit, deducted from your prepaid wallet only when a consultation is marked complete. Charged per visit, not per patient — if a patient visits twice in a month, that is 2 × 9rs+gst. Cancellations, no-shows and unconsulted tokens are never charged. No monthly fee, no annual contract.' },
  ...
  { q: 'How do I recharge wallet?', a: 'Recharge anytime from the clinic dashboard via UPI, card or net banking. 9rs+gst auto-deducts per completed visit, you can see every transaction in the wallet ledger, and we alert you before the balance runs low.' },
];
