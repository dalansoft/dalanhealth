...
const demos: { role: Role; title: string; subtitle: string; mobile?: string; email?: string; preset: string; features: string[]; icon: LucideIcon; tone: string; color: string; name: string }[] = [
  {
    ...
    preset: 'OTP: 123456',
    features: ['Doctor search', 'QR join queue', 'Live token tracking', '₹9 incl. GST booking'],
    icon: Smartphone,
  ...
  },
  {
    ...
    features: ['Revenue analytics', 'Clinic monitoring', 'Plans & pricing', 'Support tracking'],
    icon: ShieldCheck,
