...
const tx = [
  ...
  { date: '12 Jan', type: 'use' as const, amount: 0.5, note: 'Adjusted on booking ₹9 + GST' },
    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border hairline bg-warning-500/5 p-4 flex gap-3 items-start">
        ...
        <div className="text-xs text-ink-700 dark:text-ink-200">
          Cashback is not withdrawable. You can use up to 50% of any booking fee. On a ₹9 + GST booking, max 50% is applied — you pay the remaining amount.
        </div>
      </div>
