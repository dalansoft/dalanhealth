  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border hairline bg-white dark:bg-ink-900 p-4">
        ...
        <div className="mt-1 text-xs text-muted">+ ₹9 + GST booking fee · adjustable with cashback</div>
      </div>

      <div className="grid grid-cols-2 gap-3">
        <Button size="lg" onClick={() => navigate('/patient/queue')}>Join queue · Free</Button>
        <Button size="lg" variant="outline" onClick={() => navigate('/patient/queue')}>Book · ₹9 + GST</Button>
      </div>
