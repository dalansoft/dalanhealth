...
const values = [
  ...
  { icon: IndianRupee, title: 'Honest pricing', desc: '₹15 + GST per visit. No setup fee, no subscriptions, no contracts, no surprises.' },
      ...
      >
        <div className="max-w-3xl mx-auto space-y-5 text-base leading-relaxed text-ink-700 dark:text-ink-200">
          ...
          <p>
            ...
            <span className="font-semibold text-ink-900 dark:text-ink-50"> ₹15 + GST per visit</span>, nothing else.
          </p>
          <p>
