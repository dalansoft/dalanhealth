    ...
    <LegalShell eyebrow="Legal" title="Privacy Policy">
      ...
      <Block heading="Information we collect">
        <Bullets items={[
          ...
          <><strong>Billing data</strong> — wallet recharges and per-visit deductions (₹9 + GST per completed patient), kept as a transaction ledger.</>,
  ...
  return (
    <LegalShell eyebrow="Legal" title="Terms of Service">
      ...
      <Block heading="4. Pricing and wallet">
        <Bullets items={[
          <><strong>₹9 + GST per completed patient</strong> is deducted from the clinic's prepaid wallet when a consultation is marked complete.</>,
  ...
  return (
    <LegalShell eyebrow="Legal" title="Compliance & Security">
      ...
      <Block heading="Payments and tax">
        <p>
          Platform fees (₹9 + GST per completed patient) are GST-compliant, with a full wallet ledger available to
