...
const plans: Record<Plan, { title: string; price: string; period: string; perks: string[] }> = {
  starter: { title: 'Starter', price: '₹9 incl. GST', period: '/visit', perks: ['Unified queue', 'Billing', '2 staff'] },
  growth: { title: 'Growth', price: '₹9 incl. GST', period: '/visit', perks: ['Unlimited staff', 'Analytics', 'WhatsApp + Push'] },
};
