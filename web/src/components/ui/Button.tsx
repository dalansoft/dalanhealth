...
const variants: Record<Variant, string> = {
  primary:
    'bg-gradient-to-br from-brand-600 to-brand-500 text-white shadow-glow hover:shadow-[0_0_0_1px_rgba(47,127,255,0.2),0_14px_46px_-10px_rgba(47,127,255,0.55)] active:scale-[0.985]',
  secondary:
    'bg-gradient-to-br from-accent-600 to-accent-500 text-white shadow-glowAccent active:scale-[0.985]',
  ghost:
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex items-center justify-center font-medium transition-all duration-200 focus-ring select-none',
